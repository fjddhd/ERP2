...
public class ProductionProcessAdminController {
	...
	public Map<String, Object> selectByJitaiIdAndIssueStateAndInformNumber(Integer jitaiId, String issueState,
			String informNumber) {
		...
		map.put("rows", productionProcessService.selectByJitaiIdAndIssueStateAndInformNumber(jitaiId, issueState, infLong));
		return map;
	}
